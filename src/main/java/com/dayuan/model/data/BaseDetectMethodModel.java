 ...
 * @date 2017年8月17日
 */
public class BaseDetectMethodModel extends BaseModel {
	...
	public String getId() {
		...
		public void setDetectModularId(String detectModularId) {
			this.detectModularId = detectModularId;
		}
	...
	private BaseDetectMethod baseBean;

	public BaseDetectMethod getBaseBean() {
		return baseBean;
	}

	public void setBaseBean(BaseDetectMethod baseBean) {
