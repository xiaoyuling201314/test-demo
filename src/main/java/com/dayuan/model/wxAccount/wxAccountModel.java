package com.dayuan.model.wxAccount;

import java.util.Date;

import com.dayuan.model.BaseModel;

public class wxAccountModel extends BaseModel{
	  /**
    *
    */
   private Integer id;
...
public void setCompletionNum(String completionNum) {
