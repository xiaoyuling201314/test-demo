 ...
 */
@Controller
@RequestMapping("/ledger/regulatoryLicense")
public class BaseRegLicenseController extends BaseController {
	
	private final Logger log = Logger.getLogger(BaseRegLicenseController.class);
