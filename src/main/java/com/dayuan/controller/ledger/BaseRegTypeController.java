 ...
 */
@Controller
@RequestMapping("/ledger/regulatoryType")
public class BaseRegTypeController extends BaseController {
	
	private final Logger log = Logger.getLogger(BaseRegTypeController.class);
	...
	public ModelAndView list(HttpServletRequest request,HttpServletResponse response){
		...
		return new ModelAndView("/ledger/regulatoryType/list");
	}
	...
	public AjaxJson delete(HttpServletRequest request,HttpServletResponse response,String ids){
		...
		try {
			...
			baseRegulatoryTypeService.delete(ida);	
		} catch (Exception e) {
			log.error("**************************"+e.getMessage()+e.getStackTrace());
			jsonObj.setSuccess(false);
			jsonObj.setMsg("操作失败");
