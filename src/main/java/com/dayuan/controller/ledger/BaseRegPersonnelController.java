 ...
 */
@Controller
@RequestMapping("/ledger/regulatoryPersonnel")
public class BaseRegPersonnelController extends BaseController {
	
	private final Logger log = Logger.getLogger(BaseRegPersonnelController.class);
