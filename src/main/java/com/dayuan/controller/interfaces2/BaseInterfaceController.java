...
public class BaseInterfaceController extends BaseController {
	...
	/**
	 * 设置接口请求异常错误代码
	 * @param aj InterfaceJson对象
	 * @param resultCode 错误码
	 * @param msg 提示信息
	 * @return
	 */
	public static final InterfaceJson setAjaxJson(InterfaceJson aj, String resultCode, String msg){
	 ...
	 * @return
	 */
	public InterfaceJson setAjaxJson(InterfaceJson aj, String resultCode, String msg, Exception e){
	 ...
	 * @throws MyException 
	 */
	public static final void required(boolean bl, String tipsCode, String tipsMsg) throws MyException{
		if(!bl){
			throw new MyException("接口参数错误", tipsMsg, tipsCode);
		}
	}
	 ...
	 * @throws MyException 
	 */
	public static final void checkTime(Object time, String tipsCode, String tipsMsg) throws MyException{
		if (time == null || !DateUtil.checkDate(time.toString())) {
			throw new MyException("接口参数错误", tipsMsg, tipsCode);
		}
	}
	...
	public TSUser tokenExpired(String userToken) throws MyException{
		...
		if(cache != null){
			...
			if (null != user && System.currentTimeMillis() < cache.getTimeOut()) {
				...
				throw new MyException("无效token", "token已失效，请重新登录！", WebConstant.INTERFACE_CODE6);
			}
		}else{
			//无效token
			throw new MyException("无效token", "token已失效，请重新登录！", WebConstant.INTERFACE_CODE6);
