...
public class SysPrintLog {
    ...
    public SysPrintLog(String userid, String username, String remoteip, String requesturi, 
			String module, String className, String func, short operatorResult, String printCode, String exception,
			Date operatetime, String requestParam) {
		super();
		this.userid = userid;
    ...
    public SysPrintLog(String remoteip, String requesturi, 
			String module, String className, String func, short operatorResult, String printCode, String exception,
			Date operatetime) {
		super();
		this.remoteip = remoteip;
