...
public class SpecialOffer {
    ...
    /**
     *	折扣率，输入小数，保留4位小数 update by xiaoyl 2020/03/02
     */
	...
	public Short getApplyAllItems() {
		return applyAllItems;
	}

	public void setApplyAllItems(Short applyAllItems) {
		this.applyAllItems = applyAllItems;
	}
