...
public class TopupActivities {
    ...
    //活动配置详情
    private List<TopupActivitiesDetail> detailList;
    
 

    public List<TopupActivitiesDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<TopupActivitiesDetail> detailList) {
