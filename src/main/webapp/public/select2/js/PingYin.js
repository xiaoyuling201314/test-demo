(function () {
    var PinYin = {
        ...
        "ju": "\u97a0\u62d8\u72d9\u75bd\u9a79\u83ca\u5c40\u5480\u77e9\u4e3e\u6cae\u805a\u62d2\u636e\u5de8\u5177\u8ddd\u8e1e\u952f\u4ff1\u53e5\u60e7\u70ac\u5267\u5028\u8bb5\u82e3\u82f4\u8392\u63ac\u907d\u5c66\u741a\u67b8\u6910\u6998\u6989\u6a58\u728b\u98d3\u949c\u9514\u7aad\u88fe\u8d84\u91b5\u8e3d\u9f83\u96ce\u97ab\u849f",
        ...
        "pi": "\u7812\u9739\u6279\u62ab\u5288\u7435\u6bd7\u5564\u813e\u75b2\u76ae\u5339\u75de\u50fb\u5c41\u8b6c\u4e15\u9674\u90b3\u90eb\u572e\u9f19\u64d7\u567c\u5e80\u5ab2\u7eb0\u6787\u7513\u7765\u7f74\u94cd\u75e6\u7656\u758b\u868d\u8c94\u9b8d",
        "pian": "\u7bc7\u504f\u7247\u9a97\u8c1d\u9a88\u728f\u80fc\u890a\u7fe9\u8e41",
        "piao": "\u98d8\u6f02\u74e2\u7968\u527d\u560c\u5ad6\u7f25\u6b8d\u779f\u87b5",
        "pie": "\u6487\u77a5\u4e3f\u82e4\u6c15",
        "pin": "\u62fc\u9891\u8d2b\u54c1\u8058\u62da\u59d8\u5ad4\u6980\u725d\u98a6",
...
//初始化Select2
//doc:selectd对象；url：数据请求get类型的url；
//isBing:fale=只初始化不绑定；hdval：初始化默认选中的值；
//defVal：true = 没有默认值，默认选中第一个
function initSelect(doc, url, isBing, hdval,defVal) {
    if (isBing) {
        $.getJSON(url, function (result) {
            ...
            if (hdval != null && hdval !== "") {
                doc.select2('val', hdval);
            } else {
                if (defVal) {
                    doc.select2('val', result[0].id);
                }
            }
        });
    } else {
