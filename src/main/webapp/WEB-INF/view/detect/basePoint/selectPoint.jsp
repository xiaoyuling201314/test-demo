    ...
    <div class="modal-content" style="margin-top: 0px;">
      ...
      <div class="modal-body cs-xlg-height">
        ...
        <div class="cs-mechanism-list-search clearfix">
          ...
          <div class="type-top">
            <ul class="types-select clearfix" id="pointTypes">
              <li><label for="select1"><input class="pull-left" type="checkbox" id="select1" checked="checked" value="0"><span class="pull-left">政府检测室</span></label></li>
              <li><label for="select2"><input class="pull-left" type="checkbox" id="select2" checked="checked" value="2"><span class="pull-left">企业检测室</span></label></li>
              <li><label for="select3"><input class="pull-left" type="checkbox" id="select3" checked="checked" value="1"><span class="pull-left">检测车</span></label></li>
            </ul>
          </div>
...
function loadPoints(){
	...
	//检测点类型
    var pointTypes = "";
	$.each($("#pointTypes input:checked"), function (index, e) {
      pointTypes += e.value + ",";
    });
    if (pointTypes.length>0){
      pointTypes = pointTypes.substring(0, pointTypes.length-1);
    }
	...
	$.ajax({
        ...
        data: {"departId":checkedDepartId,"subset":subset,"pointName":pointName,"pointTypes":pointTypes},
        dataType: "json",
...
//检测点类型
$(document).on("click","#pointTypes :checkbox",function(){
    if ($("#pointTypes input:checked").length <= 0) {
      alert("至少选择一项");
      return false;
    }
	//加载检测点列表
