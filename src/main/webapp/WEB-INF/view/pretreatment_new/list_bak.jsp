...
<%--            <img src="${webRoot}/img/pfsystem/logo.png" style="width:40px;margin-right: 5px;"alt=""/>${systemName}--%>
        ...
        <div class="col-md-4 text-center center-text"
             style="position: absolute;width: 200px;left: 50%;top: 12px;margin-left: -100px;">前处理
        </div>
    </div>
                    ...
                    if (data && data.success && data.obj) {
                        ...
                        if (tbSampling) {
                            ...
                            for (var i = 0; i < samplingDetails.length; i++) {
                                    ...
                                    sampleObj.find("._order_number").text(tbSampling.orderNumber);
                                    sampleObj.find("._ccu_name").text(tbSampling.ccuName+"："+tbSampling.iuName);
                                    sampleObj.find("._order_username").text(tbSampling.orderUsername);
                                    sampleObj.find("._order_user_phone").text(tbSampling.orderUserPhone);
                                    sampleObj.find("._order_time").text(tbSampling.orderTime);
                                    sampleObj.find("._order_fees").text("￥"+orderFees);
