  ...
  <body>
          ...
          <div class="cs-col-lg clearfix">
            <ol class="cs-breadcrumb">
              ...
              <li class="cs-fl">任务统计
              <li class="cs-fl"><i class="cs-sorrow">&gt;</i></li>
              <li class="cs-b-active cs-fl">接收任务统计
              </li>
            </ol>
          <!-- 面包屑导航栏  结束-->
             <!-- 顶部筛选 -->
             ...
             <table class="cs-table cs-table-hover table-striped cs-tablesorter" id="table">
                <thead>
                  <tr>
                    ...
                    <th class="cs-header" onclick="orderByName('table',2,'int')">接收任务数量</th>
                    <th class="cs-header" onclick="orderByName('table',3,'int')">接收完成数量</th>
                    <th class="cs-header" onclick="orderByName('table',4,'float')">接收未完成数量</th>
                    <th class="cs-header" onclick="orderByName('table',5,'float')">接收完成率</th>
	        			...
	        			$.each(data.obj.results, function(k, o) {
	        				var html="<tr>";
	        					...
	        					html+="</tr>";
	                          	...
	                          	finish.push(o.receivedFinish);
	                          	unqualified.push(o.receivedUnqualified);
	                          	receivedFinish+=o.receivedFinish;
	                          	receivedUnqualified+=o.receivedUnqualified
	        				});
	        				var taskObj=data.obj.obj;
		        			arr.push({ name : "完成率",value : receivedFinish});
		        			arr.push({ name : "未完成率",value : receivedUnqualified});
					    	fillData();
	        	}else{
	        		console.log("查询失败");
	        	}
