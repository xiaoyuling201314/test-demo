...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <c:if test="${tab1==1}">
	...
	<div class="Section0 _separately_print _${receiveBean.collectCode}_${pageNumber.index}" style="layout-grid:15.6000pt;padding-bottom: 100pt;">
			...
			<tr style="height: 36px;">
                  ...
                  <td width="116" valign="center"
					  ...
					  <span style="float:left;padding: 0px 0;position: absolute;left: 15px;z-index: 10; font-size:14pt; top: 0px;line-height: 30px;margin-left: -8px;">防<br>伪<br>码</span>
                           <img width="100" height="100" id="qrCodePath" src="${webRoot}/pay/generatorQrCode?qrCode=${samplingQrPath}&collectCode=${receiveBean.collectCode}&scan=1" style="float:right; margin-right:-10px;position: absolute;top: -6px;left: 30px;" />
                  </td>
			</tr>
			</tbody>
		</table>
				...
				<td width="691" valign="center" colspan="7"
					...
					<p class="MsoNormal" align="justify"
					   style="float: right; margin-right:5.6500pt;text-align:justify;text-justify:inter-ideograph;">
						<span style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;background:rgb(255,255,255); mso-shading:rgb(255,255,255);" id="printTime">打印时间：<fmt:formatDate value="<%=new java.util.Date()%>" pattern="yyyy-MM-dd HH:mm:ss"/></span>
					</p></td>
			</tr>
			<tr style="height: 36px;" >
...
<%--
					<p class="MsoNormal MsoNormal2" align="center"
					   style="display:inline; margin-right:5.6500pt;text-align:center;"><span
							style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;" id="requesterName"></span><span
							style="font-family:宋体;mso-ascii-font-family:Calibri;mso-hansi-font-family:Calibri; mso-bidi-font-family:'Times New Roman';font-size:14pt;mso-font-kerning:1.0000pt;">
    <o:p></o:p></span></p>--%>
					<p class="MsoNormal MsoNormal2" style="text-align:left;">
						<span style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;" id="requesterName"></span>
				...
				<td width="551" valign="center" colspan="6"
					...
					<p class="MsoNormal MsoNormal2"
					   style="display:inline; text-align:left;"><span
							style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;" id="requesterPhone"></span><span
    ...
    <o:p></o:p></span></p></td>
				<td width="551" valign="center" colspan="6"
					...
					<%--<p class="MsoNormal MsoNormal2"
					   style="display:inline; text-align:left;"><span
							style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;" id="companyAddress"></span><span
							style="font-family:宋体;color:rgb(0,0,0);letter-spacing:0.0000pt; text-transform:none;font-style:normal;font-size:14pt; mso-font-kerning:1.0000pt;">
    <o:p></o:p></span></p>--%>
					<p class="MsoNormal MsoNormal2" style="text-align:left;">
						<span style="mso-spacerun:'yes';font-family:宋体;color:rgb(0,0,0); letter-spacing:0.0000pt;text-transform:none;font-style:normal; font-size:14pt;mso-font-kerning:1.0000pt;" id="companyAddress"></span>
						<span style="font-family:宋体;color:rgb(0,0,0);letter-spacing:0.0000pt; text-transform:none;font-style:normal;font-size:14pt; mso-font-kerning:1.0000pt;"><o:p></o:p></span>
					</p>
				</td>
			</tr>
         ...
         <o:p></o:p></span></b></p></td>
          ...
          <o:p></o:p></span></b></p></td>
								...
								<c:forEach items="${list}" var="samplingDetail" varStatus="status" begin="${(pageNumber.index-1)*10 }" end="${pageNumber.index*10-1}" >
									...
									<c:if test="${samplingDetail.conclusion!='' && receiveBean.collectCode==samplingDetail.collectCode}">
										...
										<c:choose>
											<c:when test="${showPurchaseNumber==1 || showPurchaseNumber==2}">
												<td width="" valign="center"
													style="width:170px;border-left:none; mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext; border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext; mso-border-bottom-alt:0.5000pt solid windowtext;">
													<p class="MsoNormal" align="center" style="text-align:center;"><span
															style="mso-spacerun:'yes';font-family:宋体;mso-ascii-font-family:Calibri; mso-hansi-font-family:Calibri;mso-bidi-font-family:'Times New Roman';font-size:14pt; mso-font-kerning:1.0000pt;">${samplingDetail.itemName}</span><span
															style="font-family:宋体;mso-ascii-font-family:Calibri;mso-hansi-font-family:Calibri; mso-bidi-font-family:'Times New Roman';font-size:14pt;mso-font-kerning:1.0000pt;">
	         <o:p></o:p></span></p></td>
											</c:when>
											<c:otherwise>
...
<!-- 											&nbsp;&nbsp;&nbsp;&nbsp;3.本报告复印无效<br/> -->
								 ...
								 <tr <%--style="height:29.1000pt;"--%>>
									<td width="691" valign="center" colspan="7"
										...
										<span style="font-family: 宋体; font-size:14pt; display:inline-block;margin-left: 288px;margin-bottom: 5px;">
