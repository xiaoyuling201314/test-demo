		 ...
		 <h2 class="system-title text-center">
						...
						<div class="is-flex">
							<div class="company-all" style="box-shadow: none;padding-left: 15px;">
								<div class="company-name2">
									抽样单号：<b>${sampling.samplingNo}</b> <span class="pull-right"><fmt:formatDate value="${sampling.samplingDate}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
								</div>
								<div class="company-name2">
									<span></span>
								</div>
						...
						<div class="is-flex">
							<div class="company-all" style="box-shadow: none;padding-left: 15px;">
								...
								<div class="address">
									...
									<p class="text-indent">
										<span><c:choose><c:when test="${systemFlag==1}">摊位名称：</c:when><c:otherwise>经营户名称：</c:otherwise></c:choose><i class="text-diy">${sampling.opeShopName}</i></span>
									</p>
									<p class="text-indent">
			...
			<div class="new-list zz-tp">
				<div class="stock-name is-flex">
					<div class="is-flex">
						<i class="iconfont icon-ceshi" style="font-weight: normal;"></i>样品数据
					</div>
								...
								<c:otherwise>
									<div class="origin-content cs-hide">
										...
										<div class="origin-info">
											...
											<p>供货商：${detail.supplier}</p>
											<p>电话：${detail.supplierPhone}</p>
			...
			<div class="company-all-info point-style sample-info  zz-tp is-flex" style="flex-direction: column;">
				<div class="stock-name is-flex">
					<div class="is-flex">
						<i class="iconfont icon-yemian" style="font-weight: normal;"></i>检测单位
					</div>
				</div>
				<div class="is-flex">
