...
<span style='position:absolute;
  ...
  宋体'>抽样人员：
						<c:choose>
							<c:when test="${not empty l.samplSignatureFile and  l.samplSignatureFile!=''}">
								<img height="50" width="70" src="${webRoot}/resources/${l.samplSignatureFile}" alt="章"/>
							</c:when>
							<c:otherwise>
								${l.sampling.samplingUsername}
							</c:otherwise>
						</c:choose>
				</span> </p>
