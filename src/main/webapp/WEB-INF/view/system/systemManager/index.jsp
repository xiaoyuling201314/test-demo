...
<div data-options="region:'center'" id="div1" style="padding:3px 3px; border:0;">
    <div class="panel-artic">
        <div class="panel-artic-con bg-success">
            <p class="cs-article-title">软件名称：${appName}</p>
            <p><strong>软件简介：</strong>${tsSystemManager.introduce}</p>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-2 col-md-2">
                <div class="download-img">
                    <img src="${webRoot}/systemManager/appQrcodeImg.do?url=${webRoot}/systemManager/download&urlPath=${webRoot}/resources/${tsSystemManager.urlPath}"
                         alt=""
            ...
            <div class="clearfix cs-used col-sm-10 col-md-10 cs-none-pr">
                    ...
                    <div class="cs-tab-top clearfix">
                        <div class="cs-app-info cs-fl">
                            <div class="cs-app-span">
                                <span class="cs-app-ver">启用时间：<i
                                        class="text-primary">${tsSystemManager.startTime}</i></span>
                                <span class="cs-app-ver">版本：<i
                                        class="text-primary">${tsSystemManager.versions}</i></span>
                            </div>
                            <div class="cs-app-span">
                                <span class="cs-app-ver">支持系统：<i class="text-primary">Android4.4以上</i></span>
                                <span class="cs-app-ver">大小：<i
                                        class="text-primary">${tsSystemManager.fileSize}M</i></span>
                                <span class="cs-app-ver">强制更新：<i
                                        class="text-primary">${tsSystemManager.param2}</i></span>
                            </div>
                            
                        </div>
                        </c:when>
                        ...
                        <div class="cs-tab-top clearfix">
                            <div class="col-sm-2 col-md-2">
                                <div class="download-img">
                                    <img src="${webRoot}${appTypeImg.filePath}" alt=""
                                         style="width:100%; max-width:126px;">
                                </div>
                            </div>
                            <div class="clearfix cs-used col-sm-10 col-md-10 cs-none-pr">
                                    ...
                                    <div class="cs-tab-top clearfix">
                                        ...
                                        <div class="cs-soft-download cs-fl" id="btn1">
                                            <c:if test="${editPermission eq '1'}">
                                                <a href="javascript:" class="" data-id="${tsSystemManager.id}"
                              ...
                              <span class="btn btn-success cs-tab-btn cs-tab-btnS"><i
                                     ...
                                     <span class="btn btn-primary cs-tab-btn text-primary cs-tab-btnS"><i
                                             class="icon iconfont icon-xiafa"></i>安装包</span></a>
                                            <c:if test="${!empty tsSystemManager.param3}">
                                                <a href="${webRoot}/resources/${tsSystemManager.param3}" class="" target="_blank">
                                     <span class="btn btn-primary cs-tab-btn text-primary cs-tab-btnS"><i
                                             class="icon iconfont icon-xiafa"></i>操作说明</span></a>
                                            </c:if>
                                            <c:if test="${tsSystemManager.appType ne 'APP' && patchNumber ne '0'}">
                                                <a onclick="window.parent.location.href='${webRoot}/systemManager/patchDownload.do?type=${tsSystemManager.appType}&editPermission=${editPermission}&deletePermission=${deletePermission}'"
                                                   style="color: #0e78c9">&nbsp;补丁包下载</a>
                                            </c:if>
                                        </div>
                                    </div>
                                    <div class="cs-article-content">
                                        <div class="cs-articale-show"><a id="headingOne" role="button"
                ...
                <div class="panel panel-primary">
                    <div class="panel-body cs-not-used">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <div class="download-img">
                                <img src="${webRoot}/systemManager/appQrcodeImg.do?url=${webRoot}/systemManager/download&urlPath=${webRoot}/resources/${notEnabled.urlPath}"
                                     alt=""
                                     style="width:100%; max-width:126px;">
                            </div>
                        </div>
                        <div class=" clearfix col-sm-10 col-md-10 cs-none-pr">
                            <div class="">
                                <div class="cs-tab-top clearfix">
                                    <div class="cs-app-info cs-fl">
                                        <div class="cs-app-span">
                                            <span class="cs-app-ver">启用时间：<i
                                                    class="text-primary">${notEnabled.startTime}</i></span>
                                            <span class="cs-app-ver">大小：<i
                                                    class="text-primary">${notEnabled.fileSize}M</i></span>
                                            <span class="cs-app-ver">版本：<i
                                                    class="text-primary">${notEnabled.versions}</i></span>
                                        </div>
                                        <div class="cs-app-span">
                                            <span class="cs-app-ver">支持系统：<i
                                                    class="text-primary">Android4.4以上</i></span>
                                            <span class="cs-app-ver">强制更新：<i
                                                    class="text-primary">${notEnabled.param2}</i></span>
                                        </div>
                                        
                                    </div>
                                    </c:when>
                                        ...
                                        <div class=" clearfix col-sm-10 col-md-10 cs-none-pr">
                                            <div class="">
                                                <div class="cs-tab-top clearfix">
                                                    ...
                                                    <div class="cs-soft-download cs-fl" id="btn1">
                                                        <c:if test="${editPermission eq '1'}">
                                                            <a href="javascript:" class="" data-id="${notEnabled.id}"
                                                               onclick="btnEdit(this)">
                              <span class="btn btn-success cs-tab-btn cs-tab-btnS"><i
                                      class="icon iconfont icon-xiugai"></i>编辑</span></a>
                                                        </c:if>
                                                        <c:if test="${editPermission eq '1'}">
                                                            <a href="${webRoot}/resources/${notEnabled.urlPath}"
                                                               class="">
                                       <span class="btn btn-primary cs-tab-btn text-primary cs-tab-btnS"><i
                                               class="icon iconfont icon-xiafa"></i>安装包</span></a>
                                                        </c:if>
                                                        <c:if test="${editPermission eq '1'&& !empty notEnabled.param3}">
                                                            <a href="${webRoot}/resources/${notEnabled.param3}" target="_blank">
                                       <span class="btn btn-primary cs-tab-btn text-primary cs-tab-btnS"><i
                                               class="icon iconfont icon-xiafa"></i>操作说明</span></a>
                                                        </c:if>
                                                        <c:if test="${deletePermission eq '1'}">
                                                            <a href="javascript:" data-id="${notEnabled.id}"
                                                               onclick="btn(this)" class="">
                                       <span class="btn btn-danger cs-tab-btn text-danger cs-tab-btnS"><i
                                               class="icon iconfont icon-shanchu"></i>删除</span></a>
                                                ...
                                                <div class="cs-article-content">
                                                    <div class="cs-articale-show"><a style=" color: #05af50;"
                                                                                     id="headingOne${num.index}"
                                                                                     role="button"
                                                                                     data-toggle="collapse"
                                                                                     data-parent="#accordion"
                                                                                     href="#collapseOne${num.index}"
                                                                                     aria-expanded="true"
                                                                                     aria-controls="collapseOne${num.index}">
                                                        收起说明
                                                        <i class="icon iconfont icon-icon-up"></i></a></div>
                                                    <p class="cs-article-title">更新说明：</p>
                                                    <div id="collapseOne${num.index}"
                                                         class="cs-article-contian cs-page-show in">
                            ...
                            <div class="cs-history-line">------------------------------------- 以下为历史版本
                                -------------------------------------
                            </div>
                                            ...
                                            <div class="cs-tab-top clearfix">
                                                ...
                                                <c:when test="${software.appType eq 'APP'}">
                                                    <div class="download-img cs-fl">
                                                        <img src="${webRoot}/systemManager/appQrcodeImg.do?url=${webRoot}/systemManager/download&urlPath=${webRoot}/resources/${software.urlPath}"
                                                             alt=""
                                                             style="width:100%; max-width:126px;">
                                                    </div>
                                                    <div class="cs-app-info cs-fl">
                                                        <div class="cs-app-span">
                                                            <span class="cs-app-ver">启用时间：<i
                                                                    class="text-primary">${software.startTime}</i></span>
                                                            <span class="cs-app-ver">大小：<i
                                                                    class="text-primary">${software.fileSize}M</i></span>
                                                            <span class="cs-app-ver">版本：<i
                                                                    class="text-primary">${software.versions}</i></span>
                                                        </div>
                                                        <div class="cs-app-span">
                                                            <span class="cs-app-ver">支持系统：<i class="text-primary">Android4.4以上</i></span>
                                                            <span class="cs-app-ver">强制更新：<i
                                                                    class="text-primary">${software.param2}</i></span>
                                                        </div>
                                                        
                                                    </div>
                                                </c:when>
                            ...
                            <script>
                                ...
                                function btnEdit(obj) {
                                    var id = $(obj).data("id");
                                    var url = "${webRoot}/systemManager/addModal.do?appType=${appType}&id=" + id;
