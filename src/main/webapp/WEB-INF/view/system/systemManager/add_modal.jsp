        ...
        <ol class="cs-breadcrumb">
            ...
            <c:choose>
                <c:when test="${show eq '1'}">
                    <li class="cs-b-active cs-fl">新增软件信息</li>
                </c:when>
                <c:otherwise>
                    <li class="cs-b-active cs-fl">编辑软件信息</li>
                </c:otherwise>
            </c:choose>
        ...
        <div class="cs-search-box cs-fr">
            <form action="">
                <div class="clearfix cs-fr">
                    <a onclick="window.parent.location.href='${webRoot}/systemManager/appQrcode?appType=${appType}'"
                       class="cs-menu-btn returnBtn"><i
    ...
    <div class="cs-main">
        <div class="cs-wraper">
            <form class="registerform" id="TSSMGForm" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="param3" value="${tsSystemManager.param3}"/>
                <div width="100%" class="cs-add-new">
                    <ul class="cs-ul-form clearfix">
                        ...
                        <li class="cs-in-style  col-xs-3 col-md-3">
                            <select id="appType" name="appType" datatype="*" onchange="changeAppType(this)"
                                    nullmsg="请选择软件类型！" errormsg="请选择软件类型！">
                                <c:choose>
                                    <c:when test="${not empty appTypes}">
                                        <c:forEach items="${appTypes}" var="type">
                                            <option data-introduce="${type.introduce}"
                                                    data-devicename="${type.device_series}"
                                ...
                                <option data-introduce="Google浏览器"
                                        data-devicename="Google浏览器"
                                        value="Google浏览器">Google浏览器</option>
                            </select>
                        </li>
                        <li class="cs-name  col-xs-1 col-md-1">软件名称：</li>
                        <li class="cs-in-style col-md-3 col-xs-3">
                            <input type="text" value="${tsSystemManager.appName}" id="appName" name="appName"
                                   class="inputxt"/>
                        </li>

                        <li class="cs-name col-xs-1 col-md-1">启用时间：</li>
                        <li class="cs-in-style  col-md-3 col-xs-3"><input
                                name="impDate" class="cs-time" type="text" autocomplete="off"
                                onFocus="WdatePicker({minDate:'%y-%M-%d %H:%m:%s',startDate:'%y-%M-%d %H:%m:%s',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"
                                datatype="*" nullmsg="请选择启用时间" errormsg="请选择启用时间" value="${tsSystemManager.startTime}">
                        </li>
                        <li class="cs-name col-xs-1 col-md-1">对内版本：</li>
                        <li class="cs-in-style  col-md-3 col-xs-3">
                            <input type="text" value="${tsSystemManager.version}" name="version" class="inputxt" onkeyup="clearNoNum2(this)" onblur="clearNoNum2(this)"
                                   datatype="*"/>
                        </li>
                        <li class="cs-name col-xs-1 col-md-1">对外版本：</li>
                        <li class="cs-in-style  col-md-3 col-xs-3">
                            <input type="text" value="${tsSystemManager.param1}" name="param1" class="inputxt"
                                   datatype="*" nullmsg="请输入版本号"
                                   errormsg="请输入对外版本号"/>
                        </li>
                        ...
                        <li class="col-md-3 col-xs-3 cs-check-radio cs-li-radio">
                            ...
                            <label for="yes1">否</label>
                            <script>
                                $("input[type='radio'][name='param2'][value=" + ${tsSystemManager.param2} +"]").prop("checked", "checked");
                            </script>
                        </li>
                        <c:if test="${show eq '1'}">
                            <li class="cs-name col-xs-1 col-md-1">补丁上传：</li>
                            <li class="col-md-3 col-xs-3 cs-check-radio cs-li-radio">
                                <input class="cs-piao1" id="ye" type="radio" name="patchState" value="1"
                                       onchange="patchChange(this)">
                                <label for="ye">是</label>
                                <input class="cs-piao2" id="ye1" type="radio" name="patchState" value="0"
                                       checked="checked"
                                       onchange="patchChange(this)">
                                <label for="ye1">否</label>
                                <script>
                                    $("input[type='radio'][name='patchState'][value=" + ${tsSystemManager.patchState} +"]").prop("checked", "checked");
                                </script>
                            </li>
                            <li class="cs-name col-xs-1 col-md-1">平台上传：</li>
                            <li class="col-md-3 col-xs-3 cs-check-radio cs-li-radio">
                                <input type="hidden" id="invoice" name="invoice">
                                <input class="cs-piao1" id="yes" type="radio" name="uploadState" value="1"
                                       onchange="change(this)"
                                       checked="checked">
                                <label for="yes">是</label>
                                <input class="cs-piao2" id="yes1" type="radio" name="uploadState" value="0"
                                       onchange="change(this)">
                                <label for="yes1">否</label>
                            </li>
                        </c:if>
                        <ul id="yn" style="display:none">
                            <li class="cs-name col-xs-1 col-md-1">后台文件名称：</li>
                            <li class="cs-in-style  col-md-3 col-xs-3">
                                <input id="fullName" type="text" value="" name="fullName" class="inputxt"
                                       placeholder="真实名称,包括后缀名"
                                       nullmsg="请输入后台文件名称" errormsg="请输入后台文件名称"/></li>
                        </ul>
                        <ul id="files">
                            <li class="cs-name col-xs-1 col-md-1" id="packge">安装包：</li>
                        ...
                        <ul id="files2">
                            <li class="cs-name col-xs-1 col-md-1">操作说明：</li>
                            <li class="cs-in-style col-md-3 col-xs-3" width="210px">
                                <div class="kv-main">
                                    <input id="kv-explorer2" name="file2" type="file" onchange="fileChange(this);">
                                </div>
                            </li>
                        </ul>
                    </ul>
                    <ul class="cs-ul-form clearfix" id="introduceText">
                        ...
                        <li class="cs-in-style col-md-11 col-xs-11" style="height: auto;">
                            <textarea id="introduce" name="introduce" cols="30" rows="10"
                                      style="height:80px; width:90%;">${tsSystemManager.introduce}</textarea>
                        </li>
                    </ul>
                    <ul class="cs-ul-form clearfix" id="introduceText">
                        ...
                        <li class="cs-in-style col-md-11 col-xs-11" style="height: auto;">
                            <textarea name="description" cols="30" rows="10"
                                      style="height:80px; width:90%;">${tsSystemManager.description}</textarea>
                        </li>
                    </ul>
        ...
        <div class="modal-footer action" style="margin-top: 40px;">
            ...
            <button type="button"
                    onclick="window.parent.location.href='${webRoot}/systemManager/appQrcode?appType=${appType}'"
    ...
    $(function () {
        $("#TSSMGForm").Validform({
            tiptype: 2, beforeSubmit: function () {
                ...
                if (!$("#files2 .file-caption-name").val()) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            $("#close").attr("onclick", "window.parent.location.href='${webRoot}/systemManager/appQrcode?appType=${appType}'")
                        } else {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#files .file-caption-name").val("${tsSystemManager.packgeFileName}");
        ...
        $("#files2 .file-caption-name").val("${tsSystemManager.documentFileName}");
    });
