...
<!-- 选择档口 - 下拉框 -->
<select id="business_select2" class="js-data-example-ajax"></select>
...
<script type="text/javascript">
    ...
    function getBusinessByRegId(regId){
        //清空选项
        ...
        $("#business_select2").select2({
            ...
            width: "100%",
            ajax: {
                url: "${webRoot}/regulatory/business/select2BusinessData",
                dataType: 'json',
                delay: 250,
                data: function(params) {//发送到服务器的数据
                    ...
                    return {
                        regId: regId,
                        shopCode: params.term, //后端取 key 它就是搜索关键字
     ...
     * 获取已选数据数组
     */
    function getBusinessSelect2Data() {
        return $('#business_select2').select2('data');
    }
</script>
