            ...
            <div class="address">
                <p class="text-indent">
                    <span>
                        ...
                        <i class="text-diy"><b>${busCode}</b></i>
                    </span>
                </p>
                <p class="text-indent">
                    <span>
                        ...
                        <i class="text-diy">${busName}</i>
                    </span>
                </p>
                <p class="text-indent">
                    <span>经&ensp;营&ensp;者：<i class="text-diy">${busUserName}</i></span>
                </p>
                <div class="address">
        ...
        <div class="stock-name is-flex">
            ...
            <div class="ui-data is-flex"><i class="icon iconfont icon-daka"></i>
                ...
                <ul class="ui-data-ul cs-hide" id="over-btn2">
                    ...
                    <li class="ui-data-select">近2月</li>
    ...
    function queryCheckData() {
        switch ($(".ui-select-name").text()) {
            case "自定义":
                ...
                break;
            case "近2月":
                var queryStart0 = newDate().DateAdd("m", -2).DateAdd("d", 1).format("yyyy-MM-dd");
