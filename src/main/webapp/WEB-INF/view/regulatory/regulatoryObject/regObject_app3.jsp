    ...
    <div class="company-all-info zz-tp is-flex">
        ...
        <div class="company-all">
            ...
            <div class="address">
                ...
                <%--                <p class="is-flex stall-num"><i class="icon iconfont icon-108"></i><span>摊位：<i--%>
                <%--                    class="text-diy">100个</i></span> <span><i--%>
                <%--                    class="icon iconfont icon-jianceche"></i>流动：<i class="text-diy">10个</i></span>--%>
                <%--                </p>--%>
            </div>
        </div>
    </div>
    ...
    <div class="new-list">
        <div class="stock-name is-flex">
            ...
            <div class="search-form is-flex">
                <input type="text" id="search2" class="ui-search-time" placeholder="请输入信息" autocomplete="off">
                <button class="btn btn-default" onclick="queryCheckData();">搜索</button>
            </div>
        </div>
        <div class="ui-dtpicker is-flex clearfix">
        ...
        <div class="invoice-list new-invoice-list clearfix" id="checkData">
            <div class="no-data" style="display: flex; align-items: center;justify-content: center;flex-direction: column;">
                <img src="${webRoot}/img/app/none.png" alt="" style="width: 65%;">
            </div>
        </div>
    </div>
            ...
            <a class="is-flex" href="javascrpit:;">
                <div class="zz-food dis-t">
                    <div class="invoice-top">
                        <span class="piao-detail" href="javascript:;">商铺：<b class="_reg_user_name"></b></span>
