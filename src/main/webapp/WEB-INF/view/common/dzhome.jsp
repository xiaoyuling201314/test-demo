  ...
  <body>
      ...
      <div class="cs-topbar">
        <div class="cs-navbar-header">
          <i class="cs-navbar-brand" id="nav-logo" ><img src="${webRoot}/img/dz/dzlogo2.png" alt="" /></i>
        </div>
        ...
        <div class="cs-collapse cs-navbar-collapse cs-navbar-ex1-collapse cs-re-box">
          ...
          <!-- 一级导航栏 结束-->
          <!-- <div class="cs-detect-time">
          	2018-7-31 18:47:14
          </div> -->
          <div class="cs-detect-name">
          	<!-- <i class="icon iconfont icon-jigou"></i> -->端州区食品药品监督管理局 &nbsp;&nbsp;&nbsp;&nbsp; <i class="cs-userName">${session_user.realname}，欢迎您</i>
          </div>
          <!-- 消息提醒 开始-->
          <ul class="cs-nav-right cs-float-r" style="width: 160px;">
          	<c:forEach items="${menus}" var="menu">
          		<!-- 不合格提醒 开始-->
          ...
          <!-- 用户信息 开始--> 
            <li class="cs-messages-dropdown cs-dropdown-user" style="width:48px;">
              <a id="cs-user-show" href="#" title="" class="cs-dropdown-toggle cs-user-show" data-toggle="dropdown"><i title="用户" class="icon iconfont icon-yonghu" style="font-size: 22px;" data-menuid="${menu.id}"></i>
...
<!-- 左侧导航栏 开始 -->
	<div id="leftNav" class="blue-style"></div>
            	
<!-- 左侧导航栏 结束 -->

	<!-- 内容主体 开始 -->
    <div id="page-wrapper" class="blue-style">
