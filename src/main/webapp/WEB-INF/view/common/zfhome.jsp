      ...
      <div class="cs-topbar">
        ...
        <div class="bottom-side-nav">
          ...
          <div class="logout-btn logout">
          	<i title="退出系统" class="icon iconfont icon-tuichu"></i>
          </div>
          </div>
          <!-- 消息提醒 结束-->
...
<script type="text/javascript">
	...
	$(function(){
		...
		//加载子菜单
		$(document).on("mouseover", ".firstMenu", function(){
		...
		$(document).on("mouseover", ".cs-navbar-nav,.firstMenu,.cs-dropdown", function(){
			$('#leftNav').show()
		})
		$(document).on("mouseout", ".cs-navbar-nav,.firstMenu,.cs-dropdown", function(){
			$('#leftNav').hide()
		})
		//系统退出
...
$(document).ready(function(){
	$('.firstMenu a:first,.cs-active a:first').css({'background':'rgba(0,0,0,0)','padding-right':'15px'})
})
</script>
