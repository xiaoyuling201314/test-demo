	 ...
	 <div class="cs-col-lg clearfix">
          <!-- 面包屑导航栏  开始-->
            <ol class="cs-breadcrumb cs-fl">
              ...
              <li class="cs-b-active cs-fl">消息提醒
              </li>
            </ol>
          ...
          <table class="cs-mail-content">
            <tr>
              ...
              <td class="cs-no-bd" style="padding-right:40px;">
              	...
              	<!-- <div class="cs-divtxt cs-text-nowrap" id="toUserId">
              	<input type="hidden" name="groupID" id="groupID"/>
              	</div>
              	 -->
              </td>
             ...
             <!-- <tr>
              <td class="cs-mail-name">接收对象：</td>
					<td class="cs-check-radio" style="padding-right:40px;">
						<input class="cs-show-jigou" id="jigou" type="radio" name="name" checked="true" value="1"/><label for="jigou">接收机构</label>
						<input class="cs-show-dian" id="dian" type="radio" name="name" value="0"/><label for="dian">接收人</label>
						<a href="javascript:;" class="cs-menu-btn cs-fl" onclick="selectReceivingObject();"><i class="icon iconfont icon-zengjia"></i>增加</a>
					</td>
			</tr>-->
            <tr>
            
              <td class="cs-mail-name"><input type="hidden" name="toUserType" id="toUserType"/>标题：</td>
            ...
            <tr>
              <td class="cs-mail-name cs-mail-top">正文：</td>
            ...
            <tr>
            	<td colspan="2" style="padding-left: 100px; text-align:center;"><a class="cs-menu-btn cs-send-btn" id="btnSave"><i class="icon iconfont icon-fasong" ></i>发送</a></td>
