...
<body class="easyui-layout">
	...
	<div class="cs-modal-box cs-hide" style="margin: 0 auto;">
		...
		<iframe id="iframe1" style="width: 730px;padding: 40px;margin: 0 auto;"></iframe>
	</div>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < childBtnMenu.length; i++) {
			/* if (childBtnMenu[i].operationCode == "1408-1") {
				monitor=1;
				monitorObj=childBtnMenu[i];
			} else */ if (childBtnMenu[i].operationCode == "1408-2") {//回放
				playback=1;
		...
		var op = {
			...
			funBtns : [//操作列按钮 
			{
				...
				style : playbackObj,
				action : function(id) {
					location.href="${webRoot}/data/lawInstrument/viewPlayBack?id="+id+"&type=1";
				}
			} ]
		};
