  ...
  <%--
          ...
          <!-- 面包屑导航栏  开始-->
            <ol class="cs-breadcrumb">
              ...
              <li class="cs-b-active cs-fl">微信配置</li>
            </ol>
          <!-- 面包屑导航栏  结束-->
            <div class="cs-search-box cs-fr">
              <form action="datagrid.do">
                <div class="cs-search-filter clearfix cs-fl">
                <input class="cs-input-cont cs-fl focusInput" type="text" name="accountName" placeholder="请输入关键字" />
        ...
        <ul class="cs-ul-form clearfix">
            ...
            <li class="cs-in-style cs-modal-input">
                <div class="cs-all-ps">
                    <div class="cs-input-box">
                        ...
                        <input type="text" name="departNames" readonly="readonly" class="sPointName cs-down-input" datatype="*"
                               nullmsg="请选择机构" errormsg="机构错误!"/>
         ...
         <ul class="cs-ul-form clearfix">
                ...
                <ul class="cs-ul-form clearfix">
                    ...
                    <li class="cs-in-style cs-modal-input" width="210px" >
                    <input type="text" name="accountAppsecret" class="inputxt" datatype="*" autocomplete="off"  nullmsg="请输入公众号密码" /></li>
                    <li class="col-xs-4 col-md-4 cs-text-nowrap">
                      <div class="Validform_checktip"></div>
                 ...
                 <ul class="cs-ul-form clearfix">
                    ...
                    <li class="cs-in-style cs-modal-input" width="210px" >
                    <input type="text" name="accountUser" class="inputxt"   autocomplete="off"   /></li>
                    <li class="col-xs-4 col-md-4 cs-text-nowrap">
                      <div class="Validform_checktip"></div>
                    </li>
                </ul>
                 <ul class="cs-ul-form clearfix">
                    ...
                    <li class="cs-in-style cs-modal-input" width="210px" >
                    <input type="text" name="accountUserPhone" class="inputxt"   autocomplete="off"   /></li>
                    <li class="col-xs-4 col-md-4 cs-text-nowrap">
                      <div class="Validform_checktip"></div>
                    </li>
                </ul>
                <ul class="cs-ul-form clearfix">
                   ...
                   <ul class="cs-ul-form clearfix">
                    <li  class="cs-name  col-xs-3 col-md-3" width="20%">短信配置：</li>
                    <li class="cs-in-style cs-lg-style cs-modal-input" >
                    <textarea class="cs-remark" name="signName" id="signName" ></textarea></li>
                </ul>
              <!--  <ul class="cs-ul-form clearfix">
	...
	var dgu = datagridUtil.initOption({
		tableId: "dataList",
		tableAction: "${webRoot}/wx/account/datagrid.do",
        tableBar: {
            title: ["你送我检","微信配置"],
            hlSearchOff: 0,
            ele: [{
            ...
            topBtns: [{
                show: Permission.exist("1418-1"),
                style: Permission.getPermission("1418-1"),
		...
		funBtns: [
	    	{
                show: Permission.exist("1418-3"),
                style: Permission.getPermission("1418-3"),
	    		action: function(id){
	    			getId(id);
	    		}
	    	}, {
                 show: Permission.exist("1418-2"),
                 style: Permission.getPermission("1418-2"),
	    		action: function(id){
	    			deleteIds = id;
            ...
            $.ajax({
                ...
                success: function (data) {
                   ...
                   if(obj){
                	     ...
                	     $("#signName").text(obj.signName);//短信配置
