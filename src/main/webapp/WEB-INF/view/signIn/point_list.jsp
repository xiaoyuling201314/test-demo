  ...
  <body>
          ...
          <!-- 面包屑导航栏  开始-->
            <ol class="cs-breadcrumb">
              ...
              <li class="cs-b-active cs-fl">打卡签到
              </li>
            </ol>
          <!-- 面包屑导航栏  结束-->
	...
	if(Permission.exist("1499-1")){
		var html='<a class="cs-menu-btn" onclick="punchClock()" ><i class="'+Permission.getPermission("1499-1").functionIcon+'"></i>'+Permission.getPermission("1499-1").operationName+'</a>';
		$("#showBtn").append(html);
	}
	$(function(){
