            ...
            <span class="check-date cs-hide">
               <!-- <span class="cs-name">时间:</span> -->
	                <span class="cs-in-style cs-time-se cs-time-se">
	                	<input name="task.taskSdate" style="width: 100px;" class="cs-time Validform_error" id="start" type="text" onclick="WdatePicker()" datatype="date" nullmsg="请选择任务起止时间" errormsg="请选择任务起止时间" value="">
	                	<!-- <span style="padding:0 5px;">至</span> -->
	                    <input name="task.taskSdate" style="width: 100px;" class="cs-time Validform_error" id="end" type="text" onclick="WdatePicker()" datatype="date" nullmsg="请选择任务起止时间" errormsg="请选择任务起止时间" value="">
	                </span>
	                <span>
             ...
             <table class="cs-table cs-table-hover table-striped cs-tablesorter" id="table">
                <thead>
                  <tr>
                    ...
                    <th class="cs-header columnHeading firstContextStyle" onclick="datagridUtil.orderBy2('table',2,'string')">被检单位<span class="sortIcon icon iconfont icon-sort"></span></th>
...
<%--                    <th class="cs-header columnHeading contextNumber" onclick="datagridUtil.orderBy2('table',6,'float')">不合格率<span class="sortIcon icon iconfont icon-sort"></span></th>--%>
 ...
 <!-- Button to trigger modal -->
    ...
    if("${session_user.pointId}"=="" && Permission.exist("1311-3")){
	        	...
	        	if(data && data.success){
        			...
        			$.each(data.obj, function(k, v) {
        				...
        				var bigbang="<tr>"
                            ...
                            +"<td class='firstContextStyle'><a class='cs-link text-primary aa' data-rowid="+v.regId+">"+v.regName+"</a></td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary num' data-rowid="+v.regId+">"+v.num+"</a></td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary qualified' data-rowid="+v.regId+">"+v.qualified+"</a></td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary unqualified' data-rowid="+v.regId+">"+v.unqualified+"</a></td>"
    ...
    $(document).on("click",".aa",function(){
    	...
    	if(typeObj!=undefined){
            ...
            urlPath=encodeURI('${webRoot}/statistics/orgStatisticsMon?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&typeObj="+typeObj);
    	}else {
            ...
            urlPath=encodeURI('${webRoot}/statistics/orgStatisticsMon?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname);
        }
    ...
    $(document).on("click",".num",function(){
    	...
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&pointId="+pointId));
		}
    });
  	//查看合格数
    $(document).on("click",".qualified",function(){
        ...
        var pointId=$("#point_select").val();
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"+"&pointId="+pointId));
		}
    });
  ...
  //查看不合格数
    $(document).on("click",".unqualified",function(){
        ...
        var pointId=$("#point_select").val();
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?regId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"+"&pointId="+pointId));
		}
    });
