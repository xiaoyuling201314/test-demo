             ...
             <table class="cs-table cs-table-hover table-striped cs-tablesorter" id="table">
                <thead>
                  <tr>
                    ...
                    <th class="cs-header columnHeading firstContextStyle" onclick="datagridUtil.orderBy2('table',1,'string')">辖区<span class="sortIcon icon iconfont icon-sort"></span></th>
    ...
    if(Permission.exist("1369-2")){
		        	...
		        	if(data && data.success){
		        		...
		        		$.each(data.obj.list, function(k, v) {
		        				...
		        				var bigbang="<tr>"
		                            ...
		                            +"<td class='firstContextStyle'>"+v.departName+"</a></td>"
		                            +"<td class='contextNumber'><a class='cs-link text-primary num' data-rowid="+v.departId+">"+v.num+"</a></td>"
		                            +"<td class='contextNumber'><a class='cs-link text-primary qualified' data-rowid="+v.departId+">"+v.qualified+"</a></td>"
                                    +"<td class='contextNumber'><a class='cs-link text-primary unqualified' data-rowid="+v.departId+">"+v.unqualified+"</a></td>"
		                            +"<td class='contextNumber'>"+qnum+"%</td>"
		                          /*  +"<td>"+unum+"%</td>"*/
	    ...
	    $(document).on("click",".num",function(){
	    	...
	    	if (typeObj!=undefined) {
	    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&typeObj="+typeObj));
			}else {
				showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname));
			}
	    });
	    ...
	    $(document).on("click",".qualified",function(){
	    	...
	    	var typeObj=$("#type option:selected").val();
	    	if (typeObj!=undefined) {
	    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"+"&typeObj="+typeObj));
			}else {
				showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"));
			}
	    });
	  ...
	  //查看不合格数
	    $(document).on("click",".unqualified",function(){
	    	...
	    	var typeObj=$("#type option:selected").val();
	    	if (typeObj!=undefined) {
	    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"+"&typeObj="+typeObj));
			}else {
				showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?departId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"));
			}
	    });
