                ...
                <thead>
                  <tr>
                    ...
                    <th class="cs-header columnHeading" onclick="datagridUtil.orderBy2('table',3,'int')">合格数<span class="sortIcon icon iconfont icon-sort"></span></th>
                      <th class="cs-header columnHeading" onclick="datagridUtil.orderBy2('table',4,'int')">不合格数<span class="sortIcon icon iconfont icon-sort"></span></th>
                      <th class="cs-header columnHeading" onclick="datagridUtil.orderBy2('table',5,'float')">合格率<span class="sortIcon icon iconfont icon-sort"></span></th>
<%--                    <th class="cs-header columnHeading" onclick="datagridUtil.orderBy2('table',6,'float')">不合格率<span class="sortIcon icon iconfont icon-sort"></span></th>--%>
 ...
 <!-- Button to trigger modal -->
    ...
    if("${session_user.pointId}"=="" && Permission.exist("1309-3")){
	        	...
	        	if(data && data.success){
        			...
        			$.each(data.obj, function(k, v) {
        				...
        				var bigbang="<tr>"
                            ...
                            +"<td class='firstContextStyle'>"+v.itemName+"</td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary num' data-rowid="+v.itemId+">"+v.num+"</td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary qualified' data-rowid="+v.itemId+">"+v.qualified+"</td>"
                            +"<td class='contextNumber'><a class='cs-link text-primary unqualified' data-rowid="+v.itemId+">"+v.unqualified+"</td>"
  ...
  //查看抽检总数
    $(document).on("click",".num",function(){
    	...
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&pointId="+pointId));
		}
    });
    ...
    $(document).on("click",".qualified",function(){
        ...
        var pointId=$("#point_select").val();
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=0"+"&pointId="+pointId));
		}
    });
  ...
  //查看不合格数
    $(document).on("click",".unqualified",function(){
        ...
        var pointId=$("#point_select").val();
    	if (typeObj!=undefined) {
    		showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"+"&typeObj="+typeObj+"&pointId="+pointId));
		}else {
			showMbIframe(encodeURI('${webRoot}/statistics/listStatistics?itemId='+$(this).attr("data-rowId")+"&type="+type+"&month="+month+"&season="+season+"&year="+year+"&start="+start+"&end="+end+"&did="+did+"&dname="+dname+"&conclusion=1"+"&pointId="+pointId));
		}
    });
