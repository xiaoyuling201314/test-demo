 ...
 <body ontouchstart="">
  <section class="ui-container" style="padding:10px;">
	...
	<div class="ui-navbar clearfix">
              <ul class="clearfix">
                <li class="ui-nav-top col-md-12 col-xs-12">用户登录</li>
      ...
      <div class="user-info ui-tab-list" style="padding-bottom:15px;">
        ...
        <button type="button" class="btn btn-success" style="width:80%; height:32px;" onclick="save();">登录</button>
      </div>
	  ...
	  $.ajax({
	        ...
	        success: function(data){
	        	if(data && data.success){
	        		...
	        		self.location=rootPath+"main.do";
	        	}else{
