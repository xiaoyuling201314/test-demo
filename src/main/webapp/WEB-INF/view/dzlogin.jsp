...
<script type='text/javascript' src='${webRoot}/css/login/js/jquery.particleground.min.js'></script>
 <script type='text/javascript' src='${webRoot}/css/login/js/duanzhou.js'></script>
...
.anan{
    ...
    height: 210px;
    /* width: 560px; */
    background: url(${webRoot}/css/login/img/anan.png) no-repeat;
...
.body-bg{
	background:url(${webRoot}/img/dz/bg.png) no-repeat top center;
...
<body class="body-bg">
	<div class="login-content">
		<%-- <div class="login-logo">
			<img src="${webRoot}/img/dz/dzlogo2.png"  alt="" />
		</div> --%>
		<div class="login-logo" style="width: 100%;">
		    <span class="cs-vertical-box"></span>
		    <img src="${webRoot}/img/dz/dzlogo.png"  style="vertical-align: middle;">
			<!-- <span>达元快检数据预警分析软件</span> -->
		</div>
		
		<!-- <div class="anan"></div> -->
		<div class="login-box">
			<div id="particles" class="login-body2">
				<div class="intro">
					<div class="form">
						<h2>用户登录</h2>
						<div class="userform">
	...
	<div class="ins">
		<p>© 2018 广东中检达元检测技术有限公司 All Rights Reserved.
			<br>
			推荐浏览器（谷歌chorme、360）
		</p>
...
function vbox(){
	...
	var particles = $('#particles').height();

	$('.cs-vertical-box').height((winHeight-particles)/2);
}
vbox();
