...
// map the browser API names to the spec API names
    ...
    MediaError.defaultMessages = {
        1: '您中止了媒体播放',
        2: '网络错误导致媒体下载部分失败。',
        3: '由于损坏问题或浏览器不支持媒体使用的功能，媒体播放被中止。',
        4: '由于服务器或网络故障或格式不受支持，无法加载媒体。',
        5: '媒体已加密，我们没有解密它的密钥。'
    };
