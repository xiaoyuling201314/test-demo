    	...
    	function cPlugin(o,emlnum){
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            df_box:function(){return $("</div><div class='df-box "+(sjObj.opt.alwaysShow?"alwaysShow":"")+" "+sjObj.opt.boxClassName+"' style=''></div>")},
		            df_main:function(){return $("<div class='df-main'>")},
		            df_btn:function(){
		                if(sjObj.opt.alwaysShow){
		                    return
		                }
		                return $("<div class='df-btn' style='height:"+sjObj.opt.height+"px'><div class='df-no btn btn-danger'>"+sjObj.opt.cancelText+"</div><div class='df-ok btn btn-primary'>"+sjObj.opt.okText+"</div></div>")
		            },
		            ...
		            strStart:function(text,c){
		                ...
		                console.log(this);
		                if(df.width){
		                    str='<div class="df-class">'+text+'</div><div class="df-item " style="height:'+(df.height*5-1)+'px;min-width:100px"><ul class="df-ul" data-class='+c+'>';
		                }else{
