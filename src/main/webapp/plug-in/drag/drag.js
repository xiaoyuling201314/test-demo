(function(){
	...
	b.prototype = {
		init:function(){
			...
			t.t.css({'max-height':t.w_height-t.c_height,'max-width':t.w_width-t.c_width,'position':'absolute','min-width':'200px','min-height':'200px'});
		...
		size:function(){
			...
			t.sz.css({'position':'absolute','right':0,'bottom':0,'display':'block','width':18+'px','height':'auto','cursor':'nw-resize'});
