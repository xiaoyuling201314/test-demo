...
var pickout = (function(){
	...
	/*function feedInput2(select, value){
		select.parentElement.querySelector('.pk-input').value = value;
	}*/
	/**
	...
	function prepareModal(){
		...
		var seacrBtn = document.createElement('div')
		seacrBtn.setAttribute('class', 'zz-search-btn');
		seacrBtn.innerHTML = '确定';
