...
<pkg:package xmlns:pkg="http://schemas.microsoft.com/office/2006/xmlPackage">
    ...
    <pkg:part pkg:name="/word/document.xml"
        ...
        <pkg:xmlData>
            ...
            <#assign indexNum = 0>
            <#list 1..pageNum as totalIndexNum>
                <#assign currentPage = currentPage+1 ><#--页数累加操作-->
                <w:body>
                    <w:tbl>
                        <w:tblPr>
                            <w:tblStyle w:val="5"/>
                        ...
                        <w:tr>
                            ...
                            <w:tc>
                                <w:tcPr>
                                    <w:tcW w:w="10887" w:type="dxa"/>
                                    <w:gridSpan w:val="13"/>
                                    <w:shd w:val="clear" w:color="auto" w:fill="BEBEBE" w:themeFill="background1"
                                           w:themeFillShade="BF"/>
                                    <w:vAlign w:val="center"/>
                                </w:tcPr>
                                <w:p>
                    ...
                    <#--遍历检测项目开始_start -->
                    <#--当总条数大于当前最大条数时设置本次循环范围最大值max为 pageSize*currentPage-1 即：max = 13*1-1 = 12-->
                    <#if (totalNum >= (pageSize*currentPage)) >
                        <#assign max = pageSize*currentPage-1 >
                    </#if>
                    <#--当总条数小于当前最大条数且大于当前最小条数（即：总条数大于开始索引小于最大索引）max= totalNum-1 -->
                    <#if (totalNum > (pageSize*(currentPage-1))) && (totalNum<(pageSize*currentPage)) >
                        <#assign max = totalNum-1 >
                    </#if>
                    <#list (pageSize*(currentPage-1))..max  as num>
                    <#--序号累加操作-->
                        <#assign indexNum = indexNum+1 >
                    <#--根据索引获取当前迭代出来的对象-->
                        <#assign dcr = checkList[indexNum-1] >
                        <w:tr>
                            <w:tblPrEx>
                                <w:tblBorders>
                                    <w:top w:val="single" w:color="auto" w:sz="4" w:space="0"/>
                            ...
                            <w:tc>
                                ...
                                <w:p>
                                    ...
                                    <w:r>
                                        ...
                                        <w:t>${dcr.checkDate?string("yyyy-MM-dd HH:mm:ss")}</w:t>
                                    </w:r>
                                </w:p>
                            </w:tc>
                            <w:tc>
                                ...
                                <w:p>
                                    ...
                                    <w:r>
                                        ...
                                        <w:t>${dcr.checkResult?html}</w:t>
                                         <#if (indexNum-((currentPage-1)*pageSize)) %10 ==0>
                                            <w:drawing>
                                                <wp:anchor distT="0" distB="0" distL="114300" distR="114300"
                                                    ...
                                                    <wp:wrapNone/>
                                                    <wp:docPr id="4" name="图片 4" descr="image002"/>
                                                    <wp:cNvGraphicFramePr>
                                                        <a:graphicFrameLocks
                                                                xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
                                                                noChangeAspect="1"/>
                                                    ...
                                                    <a:graphic
                                                        ...
                                                        <a:graphicData
                                                            ...
                                                            <pic:pic
                                                                    xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture">
                                                                <pic:nvPicPr>
                                                                    <pic:cNvPr id="4" name="图片 4" descr="image002"/>
                                                                    <pic:cNvPicPr>
                                                                        <a:picLocks noChangeAspect="1"/>
                                                                    </pic:cNvPicPr>
                                                                </pic:nvPicPr>
                    ...
                    <#--添加空白行_start  -->
                    <#--当总条数小于当前最大条数且大于当前最小条数（即：总条数大于开始索引小于最大索引）-->
                <#if (totalNum > (pageSize*(currentPage-1))) && (totalNum<(pageSize*currentPage)) >
                    <#list 1..(pageSize-totalNum%pageSize) as empty>
                    <#--序号累加操作-->
                        <#assign indexNum = indexNum+1 >
                        <w:tr>
                            <w:tblPrEx>
                        ...
                        <w:tr>
                            ...
                            <w:tc>
                                ...
                                <w:p>
                                    ...
                                    <#if checkImage?? && (checkImage?length >30) >
                                    <w:r>
                                        <w:rPr>
                                            <w:rFonts w:ascii="宋体" w:hAnsi="宋体" w:eastAsia="宋体" w:cs="宋体"/>
                                            <w:sz w:val="24"/>
                                        ...
                                        <w:drawing>
                                            <wp:anchor distT="0" distB="0" distL="114935" distR="114935"
                                                       simplePos="0"
                                                       relativeHeight="251661312" behindDoc="0" locked="0"
                                                       layoutInCell="1" allowOverlap="1">
                                                <wp:simplePos x="0" y="0"/>
                                                <wp:positionH relativeFrom="column">
                            ...
                            <w:tc>
                                ...
                                <w:p>
                                    ...
                                    <w:r>
                                        ...
                                        <#if reviewImage?? &&(reviewImage?length >30) >
                                            <w:drawing>
                                                <wp:anchor distT="0" distB="0" distL="114935" distR="114935"
                                                           simplePos="0"
                    ...
                    <w:p/>
                    <w:p/>
                <#--当只有1页的时候不添加页脚，否则添加页脚-->
                    <#if pageNum<=0>
                         <w:sectPr>
                             <w:pgSz w:w="11906" w:h="16838"/>
                             <w:pgMar w:top="873" w:right="1800" w:bottom="873" w:left="1800" w:header="851"
                                      w:footer="992"
                                      w:gutter="0"/>
                    ...
                    <#else>
                    <#--增加页脚的时候更改的代码 start 注意Id为 rId10 的指向，指向就是页脚的位置，全局搜索rId10可找到页脚代码位置-->
                        <w:sectPr>
    ...
    <pkg:part pkg:name="/docProps/app.xml"
        ...
        <pkg:xmlData>
            <Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"
                ...
                <Application>WPS Office_11.1.0.11115_F1E327BC-269C-435d-A152-05C5408002CA</Application>
    ...
    <pkg:part pkg:name="/docProps/core.xml"
        ...
        <pkg:xmlData>
            <cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
                ...
                <dcterms:created xsi:type="dcterms:W3CDTF">2021-12-13T01:19:00Z</dcterms:created>
                <dc:creator>dayuan</dc:creator>
                <cp:lastModifiedBy>跟着强子发大财</cp:lastModifiedBy>
                <dcterms:modified xsi:type="dcterms:W3CDTF">2021-12-21T07:07:28Z</dcterms:modified>
        ...
        <pkg:xmlData>
            <Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/custom-properties"
                ...
                <property fmtid="{D5CDD505-2E9C-101B-9397-08002B2CF9AE}" pid="3" name="ICV">
                    <vt:lpwstr>DB47AE03AC9E4F5F8EA14B9E65CC838C</vt:lpwstr>
                </property>
            </Properties>
        </pkg:xmlData>
    </pkg:part>
                                            ...
                                            <a:graphicData
                                                ...
                                                <wps:wsp>
                                                    ...
                                                    <wps:bodyPr rot="0" spcFirstLastPara="0" vertOverflow="overflow"
                                                                horzOverflow="overflow" vert="horz" wrap="none" lIns="0"
    ...
    <pkg:part pkg:name="/word/settings.xml"
        ...
        <pkg:xmlData>
            <w:settings xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006