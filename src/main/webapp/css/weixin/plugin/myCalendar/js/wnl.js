...
(function () {
    ...
    var e = {
            ...
            getNewMoons: function (t) {
                ...
                if (r.cache[i]) s = r.cache[i]; else {
                    for (var o = 0; o < 15; o++)s.push({JD: r.calc(i + 29.5306 * o), index: o}), o && (s[o - 1].days = s[o].JD - s[o - 1].JD);
                    if (s[13].JD <= t[24].JD) {
            ...
            getTerms: function (t) {
                ...
                if (i.cache[n]) r = i.cache[n]; else {
                    r.hash = {};
                    for (var s = 0, o; s < 25; s++)o = {JD: i.calc(n + 15.2184 * s), name: e.term[s % 24]}, r.push(o), r.hash[o.JD] = o;
                    i.cache[n] = r
                }
                return r
            },
            ...
            JD2000: 2451545, fromDate: function (e) {
                var t = e.getFullYear(), n = e.getMonth() + 1, r = e.getDate() + ((e.getSeconds() / 60 + e.getMinutes()) / 60 + e.getHours()) / 24,
                    i = t * 372 + n * 31 + Math.floor(r) >= 588829, s = 0;
    ...
    x.w = {}, $.each(S, function (e, t) {
        ...
        var e = this.oDate.getFullYear(), t = this.oDate.getMonth() + 1, n = this.oDate.getDate(), r = T(t) + T(n), i = this.oDate.getDay(),
            s = Math.ceil(n / 7), o = T(t) + s + i, u = this.lMonth, a = this.lDate, f = u + "\u6708" + a, l = [];
        ...
        e.localStorage = {
            test: function () {
                ...
                init: function (e) {
                    ...
                    if (!e) localStorage.clear(); else for (var t = localStorage.length - 1,
...
(function () {
    function t(t, n, r) {
        this.storage = e.ins(t, r), this.signature = n, this.lastUpdate = null, this.dataFormatter = {getter: null, setter: null}
    }
...
(function () {
    var e = window.OB.RiLi, t = e.useLunarTicketDay, n = e.lunar, r = e.dateHuochepiao, i = [], s = {}, o = function (e) {
        ...
        a = "<span class='red'>\u53ef\u9884\u8ba2{month}\u6708{day}\u65e5\u8f66\u7968</span>", f = "<em class='mh-lunar-ticket'>\u519c\u5386{l}</em>",
        l = function (e, t) {
    ...
    e.Huochepiao = {
        getHuochepiaoDay: function (e, t, n) {
            ...
            var s = this.getHuochepiaoDay(n, r, i), a = s["color"] == "red" ? "mh-hotticket" : "", f = o(s.piaodate.getMonth() + 1),
                l = o(s.piaodate.getDate()), c = [n, o(r), o(i)].join("/"),
                h = [e.today.getFullYear(), o(e.today.getMonth() + 1), o(e.today.getDate())].join("/"), p = s.piaodate.getFullYear();
            if (c >= h) {
    ...
    $.widget("rili.fakeSelect", {
        options: {data: [], onchange: $.noop, value: "", circle: !1}, _create: function () {
            ...
            this.name = n.name, this.prev = t.find(".mh-prev"), this.next = t.find(".mh-next"), this.cont = t.find("div.mh-control"), this.header = t.find(".mh-field"), this.list = t.find(".mh-list"), this.cont.find(".mh-holiday").length > 0 ? this.list.html($.format('<li val="{value}" is_sel={is_sel}>{text}</li>', n.data)) : this.list.html($.format('<li val="{value}">{text}</li>', n.data)), this.opts = this.list.find("li"), this.cont.click(function () {
                ...
                //选中指定节假日的点击事件
                e.list.hide();//选中后把该下拉框隐藏起来
                var r = $(this).addClass("mh-on"), i = r.attr("val"), s = r.text(), o = e.header.attr("val");//添加样式
                /*console.log("e--")
                 console.log(e)
                 console.log("i--")
                 console.log(i)
                ...
                //shit：此处是增加选中节假日的样式
                console.log("当前选中日期为:" + i);
                if (i && i.length == 8) {//如果当前选中的日期不为空
                    var date = i.substring(0, 4) + "-" + i.substring(4, 6) + "-" + i.substring(6);
                    $("li[date='" + date + "']").addClass("mh-on mh-on2");
                }
...
(function () {
    var e = window.OB.RiLi, t = e.msg_config, n = e.Huochepiao, r = e.mediator, i = e.lunar, s = e.Lunar, o = e.rootSelector || "",
        u = $.trim($(o + "#mh-date-y").html()), a = e.dateFestival, f = [], l, c, l, c;
    $.route = function (e, t) {
        e = e || {};
        var n;
    ...
    $.padWithZero = function (e) {
        ...
        options: {onselect: $.noop}, _create: function () {
            ...
            var l = this, c = $(this.element), h = this.options, p = new Date(s, o - 1, a || 1), d = new window.OB.RiLi.Calendar(p),
                v = d.getCalendarFirstDate(), m = this.today;
            ...
            var S = new Date(v), x = $.map(new Array(42), function (s, a) {
                ...
                $.inArray(x, f) != -1 && w.push("m mh-fes"), /*shit改动增加 m 无用*/ h != o - 1 && w.push("mh-cross-month"), (a + 1) % 7 == 0 && w.push("mh-last"), p == m.getDate() && h == m.getMonth() && c == m.getFullYear() && w.push("mh-today"), (d == 0 || d == 6) && w.push("mh-weekend");
                var T = v.festival();
                ...
                return C = T[0] && T[0].desc.length < 9 && T[0].desc || v.term || v.dateIndex == 0 && v.lMonth + "\u6708" + (v.isBigMonth ? "\u5927" : "\u5c0f") || v.lDate, C.length > 4 ? $.format(N, {
                    ...
                    solar: p,
                    lunar: C,
                    date: [c, ("0" + (h + 1)).slice(-2), ("0" + p).slice(-2)].join("-"),//此处被改动格式为2018-03-03
                    goupiao: goupiao,
                    lunarTitle: "title='" + C + "'"
                }) : $.format(N, {
                    monthClass: w.join(" "),
                    solar: p,
                    lunar: C,
                    date: [c, ("0" + (h + 1)).slice(-2), ("0" + p).slice(-2)].join("-"),
                    goupiao: goupiao,
                    lunarTitle: ""
                })
            });
            ...
            $(n.panel).delegate("li", "click", function () {
                n.panel.find("li.mh-fes").removeClass("mh-fes"),//shit添加
                ...
                //shit:此处为选中年份的点击事件添加和移除选中样式mh-on
            ...
            h = h > 9 ? h : "0" + h + "", $.each(a, function (e, t) {
                ...
                r.publish(t.type.fin, {
                    data: {
                        name: "year", value: i.getFullYear(), onchange: o, data: $.map(new Array(200), function (e, t) {
                            var n = 1901 + t;
            ...
            }, 300), i.find(".btnrefresh").click(function (e) {//shit:添加的刷新方式，外面调用该点击事件即可刷新界面
                r.publish(t.type.ftc, {
                    data: {},
                    from: n.dltMonth
                })
            }), this.btnToday = i.find(".mh-btn-today").click(function (e) {//点击返回今天的点击事件
                e.preventDefault(), r.publish(t.type.fsv, {
                    data: n.today.getFullYear(),
                    from: n.dltYear
                }), r.publish(t.type.fsv, {data: n.today.getMonth() + 1, from: n.dltMonth}), r.publish(t.type.ftc, {
                    data: {},
                    from: n.dltMonth
...
(function () {
    ...
    $.widget("rili.dayDetail", {
        options: {}, _create: function () {
            ...
            var i = this, s = $(this.element), o = this.options, u = n.getFullYear(), a = n.getMonth() + 1, f = n.getDate(), l = new Date,
                c = r.festival();
            console.log(n);
